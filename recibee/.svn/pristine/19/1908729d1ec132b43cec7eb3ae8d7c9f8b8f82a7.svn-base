                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-7">
                            ...
                            <div class="checkout__input">
                                ...
                                <p>수령주소<span>*</span><button type="button" class="site-btn">배송지변경</button></p>
                                
                                <div class="col-lg-6 addr">
                                    <div class="checkout__input">
                                        <input class="addr_post" type="text" placeholder="우편주소">
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12">
								...
								<textarea placeholder="전달 사항을 작성해 주세요"></textarea>
							</div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <div class="checkout__order__subtotal">Subtotal <span>34,000원</span></div>
                                <div class="checkout__order__total">Total <span>34,000원</span></div>
                                <!-- <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Create an account?
