                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mypage_recipe">
                            <div class="blog__item">
                                <div class="blog__item__text">
                                    <p class="reply__num">댓글 번호1</p>
                                    <p class="reply__title"><a href="#">댓글 제목이자 댓글 내용입니다. 길어질 경우에는 ...</a></p>
