...
public class GetRPTMemberAction implements IAction {
	...
	public String process(HttpServletRequest request, HttpServletResponse response)
		...
		int totalCount = service.getCountRPTMember();
		...
		List<MemberVO> list = service.getRPTMember(map);
