  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-warning">
        ...
        <div class="panel-heading">게시판 내용</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-warning">
        <div class="panel-heading"></div>
        <div class="panel-body"><img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:150%" alt="Image"></div>
        <div class="panel-heading">게시판 내용 2</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-warning">
        <div class="panel-heading"></div>
        <div class="panel-body"><img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:150%" alt="Image"></div>
        <div class="panel-heading">게시판 내용 3</div>
      </div>
    </div>
  </div>
</div><br>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-warning">
        <div class="panel-heading"></div>
        <div class="panel-body"><img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:150%" alt="Image"></div>
        <div class="panel-heading">게시판 내용 4</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-warning">
        <div class="panel-heading"></div>
        <div class="panel-body"><img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:150%" alt="Image"></div>
        <div class="panel-heading">게시판 내용 5</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-warning">
        <div class="panel-heading"></div>
        <div class="panel-body"><img src="https://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:150%" alt="Image"></div>
        <div class="panel-heading">게시판 내용 6</div>
      </div>
    </div>
