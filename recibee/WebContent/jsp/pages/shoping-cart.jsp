            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        ...
                        <a href="#" class="primary-btn cart-btn cart-btn-right"><span class="icon_loading"></span>변경사항 저장</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="shoping__continue">
                        <div class="shoping__discount">
                            <h5>마일리지 할인</h5>
                            <form action="#">
                                <input type="text" placeholder="사용가능 마일리지">
                                <button type="submit" class="site-btn">마일리지 사용하기</button>
                            </form>
                        </div>
                    </div>
                </div>
