...
$(function(){
    	...
    	$('.Rbtn').on('click', function(){
    		var check = confirm("정말 활성화 하겠습니까?");
	                    ...
	                    <div class="col-lg-6 col-md-6 col-sm-6 mypage_recipe">
	                            <div idx="<%=li.getMem_id() %>" class="blog__item">
	                                <div class="blog__item__text">
	                                    ...
	                                    <p class="dismem" >- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="margin-left:10px;" type="button" class="blog__btn DDbtn" name="delete" value="계정 비활성화" /></p>
	                                    <%}else if(li.getMem_dismember() == 999){ %>
	                                    <p class="dismem">비활성화<input style="margin-left:10px;" type="button" class="blog__btn Rbtn" name="re" value="계정 활성화" /></p>
	                                    <%}else{ %>
	                                    <p class="dismem" >탈퇴 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input style="margin-left:10px;" type="button" class="blog__btn Rbtn" name="re" value="계정 활성화" /></p>
	                                    <%} %>
	                                </div>
	                            </div>
	                    </div>
