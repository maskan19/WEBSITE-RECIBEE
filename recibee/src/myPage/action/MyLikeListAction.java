...
public class MyLikeListAction implements IAction {
	...
	public String process(HttpServletRequest request, HttpServletResponse response)
		...
		int totalCount = service.getCountMyLikeList(mem_id);
		...
		List<DishVO> list = service.getMyLikeList(map);
